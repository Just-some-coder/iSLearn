...
class TestListCollectionViewController: UICollectionViewController, TestListCollectionViewCellDelegate {
    ...
    @IBSegueAction func TestStart(_ coder: NSCoder, sender: Any?) -> TestStartNavigationViewController? {
        ...
        childVC.test = TestDataModel.sharedInstance.giveTest(sender,testType!)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let test = TestDataModel.sharedInstance.giveTest(((testType! == .classic ? 10 : 20)  + indexPath.item + 1), (testType!))
        ...
        progressView.progress = Float(test!.previousScore)/Float(test!.questions.count)
        ...
        cell.testProgress.text = "\(test!.previousScore)/\(test!.questions.count)"
